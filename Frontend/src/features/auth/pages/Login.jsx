        ...
        <div className="flex justify-center items-center bg-[#dbecb9] min-h-screen p-4">
            <form onSubmit={handleSubmit} className="bg-[#1d4d3e] p-8 rounded-2xl shadow-xl w-full max-w-md flex flex-col gap-5 border border-[#2d6e5a]">
                <div className="text-center mb-2">
                    ...
                    <p className="text-[#dbecb9] text-xs mt-1 opacity-80">Log in to manage NestIn bookings</p>
                </div>
                ...
                <button type="submit" className="mt-3 w-full bg-[#dbecb9] text-[#1d4d3e] py-2.5 rounded-lg font-bold text-sm hover:bg-white transition-all duration-200 shadow-md active:scale-[0.98] cursor-pointer">Log In</button>
            </form>
        </div>
    )
}
